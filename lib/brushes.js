...
export function generate_pencil_brush(p5, brush_diameter = 2, density = 3, diameter_variability = 1, noise_scale = 0.05, bristle_diameter = 1) {
    ...
    return (line, position, distance_from_start) => {
...
export function generate_ink_brush(p5, blotchiness = 3, min_diameter = 0.5, max_diameter = 5) {
    ...
    return (_line, position, distance_from_start) => {
